...
<h2 style = "text-align:center; font-size: 40px"> Mange Financials </h2>

<div> <!--graph-->
            <a href="Manage.php"><img src="graph.png" class = "center"/></a>
        </div>


<h2 style = "text-align:center; font-size: 40px"> Loan and Grants </h2>

<div> <!--graph-->
            <a href="apply.php"><img src="money.jpg" width = "50px" height = "100px" class = "center"/></a>
        </div>
